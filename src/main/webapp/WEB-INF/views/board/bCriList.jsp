      ...
      $(function() {
         ...
         $('#searchBtn').click(function() {
            self.location = "bcrilist" + "${pageMaker.makeQuery(1)}" 
               ...
               + "&keyword=" +$('#keyword').val()
               	// makeQuery(1) : 1로 설정한 이유는 search 
				// 버튼을 누르면 1page로 이동 해야하기 때문.
         }) // click
      }); // Ready
   </script>
...
<div id="searchBar">
	<select name="searchType" id="searchType">
		...
		<option value="i" ${pageMaker.cri.searchType == 'i' ? 'selected' : ''}>글쓴이(ID)</option>
